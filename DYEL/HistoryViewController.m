...
- (void)setExercise:(Exercise *)exercise
{
    ...
    // Get the best set for each workout date
    // Sort by weight then reps, desc
    ...
    // Get the first lift in the sorted order (so, the best) for each workout date
    ...
    // Then sort in chronological order again
    lifts = [lifts sortedArrayUsingDescriptors:@[ [NSSortDescriptor sortDescriptorWithKey:@"date" ascending:YES] ]];
    ...
    // Find appropriate bounds for x and y axes
